...
/**
 * Main class, whose main method simply calls {@link NetplayConfigurationScreen#main(String[])}.
 * 
 * Workaround for the fact that the test classpath (which contains useful things such as a log4j configuration) does not
 * seem to be available when running {@link NetplayConfigurationScreen#main(String[])} directly in Eclipse Kepler.
 * 
...
public class NetplayConfigurationScreenTestContext {
    ...
    public static void main(String[] args) {
        NetplayConfigurationScreen.main(args);
    }
}
